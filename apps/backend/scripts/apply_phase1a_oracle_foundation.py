...
def _phase1a_sql_blueprint() -> List[Tuple[str, str]]:
    ...
    ops.append((
        ...
        CREATE TABLE TOMEHUB_LIBRARY_ITEMS (
            ...
            ITEM_TYPE VARCHAR2(50) NOT NULL CHECK (ITEM_TYPE IN ('BOOK', 'ARTICLE', 'WEBSITE', 'PERSONAL_NOTE', 'HIGHLIGHT', 'INSIGHT')),
            TITLE VARCHAR2(1000),
            AUTHOR VARCHAR2(500),
            ...
            FOLDER_PATH CLOB,
            IS_PLACEHOLDER NUMBER(1) DEFAULT 0 CHECK (IS_PLACEHOLDER IN (0, 1)),
            ...
            CONSTRAINT uq_lib_items_composite UNIQUE (FIREBASE_UID, ITEM_ID)
        )
        """.strip(),
    ))
