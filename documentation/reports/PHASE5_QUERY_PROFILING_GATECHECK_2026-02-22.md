...
- Generated: `2026-02-22 23:02:29 UTC`
...
- `content_by_uid_book_source_type`: rows=1, runs=3, p50=25.38ms, p95=29.24ms, max=29.24ms
- `content_by_uid_book_created_at`: rows=2, runs=3, p50=33.45ms, p95=34.11ms, max=34.11ms
- `library_item_by_uid`: rows=200, runs=3, p50=40.26ms, p95=41.55ms, max=41.55ms
- `ingestion_status_view_by_uid`: rows=15, runs=3, p50=19.09ms, p95=20.69ms, max=20.69ms
- `search_logs_recent_window`: rows=200, runs=3, p50=47.58ms, p95=50.47ms, max=50.47ms
